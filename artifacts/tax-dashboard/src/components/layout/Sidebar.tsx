  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-60 flex flex-col z-30" style={{ background: "hsl(222 47% 11%)" }}>
      ...
      <div className="px-3 py-4 border-t" style={{ borderColor: "hsl(222 40% 18%)" }}>
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-white/5 cursor-pointer transition-all">
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white"
            style={{ background: "hsl(224 76% 45%)" }}>
            SA
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-white text-xs font-medium truncate">Sarah Mitchell</div>
            <div className="text-xs truncate" style={{ color: "hsl(215 16% 55%)" }}>Super Admin</div>
          </div>
          <LogOut className="w-4 h-4 shrink-0" style={{ color: "hsl(215 16% 55%)" }} />
        </div>
      </div>
    </div>
  );
